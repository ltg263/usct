...
public class SlidingTabLayout2 extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.SlidingTabLayout2);
        ...
        mTextsize = ta.getDimension(R.styleable.SlidingTabLayout_tl_textsize, 14);
        //com.flyco.tablayout:FlycoTabLayout_Lib  该开源库已经没有这个属性了 新版本里面
//        mTextSelectSize = ta.getDimension(R.styleable.SlidingTabLayout_tl_textSelectSize, 16);
        ...
        mTabPadding = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? 0 : 10);
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setTextSize(i == mCurrentTab ? mTextSelectSize : mTextsize);
    ...
    private void updateTabColorStyles() {
        for (int i = 0; i < mTabCount; i++) {
            View v = mTabsContainer.getChildAt(i);
    ...
    public void setTextColor(int textSelectColor) {
        this.mTextSelectColor = textSelectColor;
        updateTabColorStyles();
    }
