...
public class MoneyDetailsActivity extends BaseActivity implements ActionBarClickListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public void initTitle() {
        actionbar.setData("可用资产明细", R.drawable.ic_left_back2x, null, 0, null, this);
    ...
    protected void initData() {
        ...
        recycler.addOnItemTouchListener(new SwipeItemLayout.OnSwipeItemTouchListener(MoneyDetailsActivity.this));
        initRecyData();
        getMessageList(page);
    }
                ...
                .subscribe(new Observer<Result<MoneyDetailsVO>>() {
                    ...
                    public void onNext(Result<MoneyDetailsVO> result) {
                        ...
                        if (result.getCode() == 1) {
                            ...
                            ToastUtil.showToast(MoneyDetailsActivity.this, "登录失效，请重新登录");
                            ...
                            moneyDetailsListAdapter.setEmptyView(R.layout.empty_layout);
                            ToastUtil.showToast(MoneyDetailsActivity.this, result.getMsg());
                        }
                    }

                    @Override
                    public void onError(Throwable e) {
                        ToastUtil.showToast(MoneyDetailsActivity.this, e.getMessage());
                    }
