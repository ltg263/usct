...
/**
 * Created by HongChuangWang on 2016/11/11.
 */
public abstract class LoadMoreView {
    ...
    public void convert(BaseQuickViewHolder holder) {
    ...
    private void visibleLoading(BaseQuickViewHolder holder, boolean visible) {
        holder.setVisible(getLoadingViewId(), visible);
    }

    private void visibleLoadFail(BaseQuickViewHolder holder, boolean visible) {
        holder.setVisible(getLoadFailViewId(), visible);
    }

    private void visibleLoadEnd(BaseQuickViewHolder holder, boolean visible) {
