...
public class MoneyTwoDetailsActivity extends BaseActivity implements ActionBarClickListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public void initTitle() {
        actionbar.setData("收益资产明细", R.drawable.ic_left_back2x, null, 0, null, this);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            actionbar.setStatusBarHeight(getStatusBarHeight());
        }
        tvTopIntro.setText("*收益需手动转入到可用余额");
    }

    @Override
    protected void initData() {
        recycler.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
        recycler.addOnItemTouchListener(new SwipeItemLayout.OnSwipeItemTouchListener(MoneyTwoDetailsActivity.this));
        initRecyData();
        getMessageList(page);
    }
                ...
                .subscribe(new Observer<Result<MoneyDetailsVO>>() {
                    ...
                    public void onNext(Result<MoneyDetailsVO> result) {
                        ...
                        if (result.getCode() == 1) {
                            ...
                            ToastUtil.showToast(MoneyTwoDetailsActivity.this, "登录失效，请重新登录");
                            SctApp.getInstance().gotoLoginActivity();
                            finish();
                        } else {
                            moneyDetailsListAdapter.loadMoreFail();
                            ToastUtil.showToast(MoneyTwoDetailsActivity.this, result.getMsg());
                        }
                    }

                    @Override
                    public void onError(Throwable e) {
                        ToastUtil.showToast(MoneyTwoDetailsActivity.this, e.getMessage());
                    }
