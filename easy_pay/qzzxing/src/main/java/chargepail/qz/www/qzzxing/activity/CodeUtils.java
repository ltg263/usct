...
import chargepail.qz.www.qzzxing.camera.BitmapLuminanceSource;
import chargepail.qz.www.qzzxing.camera.CameraManager;
import chargepail.qz.www.qzzxing.decoding.DecodeFormatManager;
...
public class CodeUtils {
    ...
    public static void isLightEnable(boolean isEnable) {
        try {
            ...
            Log.i("CodeUtils","CodeUtils Exception = "+ e.toString());
        }
    }
}
