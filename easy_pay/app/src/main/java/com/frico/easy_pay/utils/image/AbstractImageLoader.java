...
public abstract class AbstractImageLoader {
    ...
    public abstract AbstractImageLoader loadImage(@NonNull Context context, @NonNull String url);  /**
     ...
     /** 使用默认配置 加载圆形图
     */
    public abstract AbstractImageLoader loadImageCircle(@NonNull Context context, @NonNull String url);

    /**
     *  使用默认配置 加载圆形图
     */
    public abstract AbstractImageLoader loadImageCircle(@NonNull Context context, @NonNull int resId);
