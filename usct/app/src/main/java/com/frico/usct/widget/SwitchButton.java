...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        viewState = new SwitchButton.ViewState();
        beforeState = new SwitchButton.ViewState();
        afterState = new SwitchButton.ViewState();
     ...
     * @param viewState
     */
    private void setUncheckViewState(SwitchButton.ViewState viewState){
        viewState.radius = 0;
     ...
     * @param viewState
     */
    private void setCheckedViewState(SwitchButton.ViewState viewState){
     ...
     * 当前状态
     */
    private SwitchButton.ViewState viewState;
    private SwitchButton.ViewState beforeState;
    private SwitchButton.ViewState afterState;
    ...
    private static class ViewState {
        ...
        float radius;
        ViewState(){}
        private void copy(SwitchButton.ViewState source){
