...
public class ImageLoaderImpl extends AbstractImageLoader {
     ...
     */
    @Override
    public AbstractImageLoader loadImageCircle(@NonNull Context context, @NonNull String url) {
        ImageLoaderOptions.Builder builder = new ImageLoaderOptions.Builder();
        builder.circle();
        return loadImage(context, url,builder.build());
    }
     ...
     */
    @Override
    public AbstractImageLoader loadImageCircle(@NonNull Context context, @NonNull int resId) {
        ImageLoaderOptions.Builder builder = new ImageLoaderOptions.Builder();
        builder.circle();
        return loadImage(context, resId,builder.build());
    }
