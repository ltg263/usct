...
import com.frico.usct.utils.DisplayUtils;

/**
 * 可以设置显示行数及全部展示的折叠TextView
 */
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        contentTextColor = typedArray.getColor(R.styleable.ExpandableTextView_contentTextColor, ContextCompat.getColor(getContext(), R.color.color_6));
        contentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_contentTextSize, DisplayUtils.sp2px(14));

        collapseExpandTextColor = typedArray.getColor(R.styleable.ExpandableTextView_collapseExpandTextColor, ContextCompat.getColor(getContext(), R.color.main_btn_selected_color));
        collapseExpandTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_collapseExpandTextSize, DisplayUtils.sp2px(14));
    ...
    private void findViews() {
        ...
        mTvContent.setOnLongClickListener(new OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                if (mListener != null) {
                    mListener.onTextLongClickListenter(getText());
                }
                return true;
            }
        });
    ...
    public interface OnExpandStateChangeListener {
        ...
        void onTextLongClickListenter(String textContent);
    }
}