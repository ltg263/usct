...
public class SwipeItemLayout extends ViewGroup {
    ...
    class ScrollRunnable implements Runnable {
        ...
        void startScroll(int startX, int endX) {
            if (startX != endX) {
                LogUtils.e(" scroll - startX - endX = " + startX + " " + endX);
        ...
        void startFling(int startX, int xVel) {
            LogUtils.e(" fling - startX = " + startX);
        ...
        @Override
        public void run() {
            LogUtils.e(" abort = " + Boolean.toString(mAbort));
            if (!mAbort) {
                boolean more = mScroller.computeScrollOffset();
                int curX = mScroller.getCurrX();
                LogUtils.e(" curX = " + curX);
