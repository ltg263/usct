...
/**
 * Created on 15/11/2.
 * 如果背景设置Drawable 可以设置各种状态下的显示效果，自定义xml
 * <?xml version="1.0" encoding="utf-8"?>
 * <selector xmlns:android="http://schemas.android.com/apk/res/android">
 * <item android:drawable="@drawable/rc_ed_pub_service_search_hover" android:state_pressed="true" />
 * <item android:drawable="@drawable/rc_ed_pub_service_search_hover" android:state_focused="true" />
 * <item android:drawable="@drawable/rc_ed_pub_service_search_hover" android:state_selected="true" />
...
public class ClearWriteEditText extends androidx.appcompat.widget.AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private OnTextClearClickListener onTextClearClickListener;
        ...
        if (getCompoundDrawables()[2] != null) {
            if (event.getAction() == MotionEvent.ACTION_UP) {
                ...
                if (touchable) {
                    ...
                    if (onTextClearClickListener != null) {
                        onTextClearClickListener.OnTextClearClick();
                    }
                }
            }
        }
    ...
    public void setOnTextClearClickListener(OnTextClearClickListener onTextClearClickListener){
        this.onTextClearClickListener = onTextClearClickListener;
    }

    public interface OnTextClearClickListener{
